...
| 스킬 | 버전 | 날짜 |
|---|---|---|
| cpg-data-extraction | v3.1 | 2026-05-07 |
| merge-skill | v1.1 | 2026-04-21 |
| 매뉴얼 | v3.1 | 2026-05-07 |

> **v3.1 변경 요약**: 작업자 간 토의용 `토의목록_<작업자>.md` append 기능 추가. 작업자가 "토의목록에 추가해줘"라고 명시 요청할 때만 동작하며, 기존 추출 흐름에는 영향 없음. 자세한 내용은 배포 폴더 루트의 `토의목록_[작업자].md` 파일 상단 사용법 블록 참조.
